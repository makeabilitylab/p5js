// A vertical wall made of black Pipes with 1-3 gaps the bird flies through. The
// constructor randomly picks how many gaps and how tall each is, then fills the
// remaining vertical space with pipes. Barriers scroll right-to-left; the game
// ends if any pipe overlaps the bird. Extends Shape.
class Barrier extends Shape {
  ...
  constructor(speed, maxGaps) {
    ...
    speed = min(9, speed); // cap scroll speed so barriers stay dodgeable
    this.speed = speed;
