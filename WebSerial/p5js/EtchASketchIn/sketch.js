...
// button and message <p> below the canvas. Paints the background once so the
// circle leaves a persistent trail (draw() never clears it).
function setup() {
 ...
 * function is called. Draws a semi-transparent circle at the current location
 * without clearing the canvas, so movement leaves an Etch A Sketch style trail.
 */
function draw() {
