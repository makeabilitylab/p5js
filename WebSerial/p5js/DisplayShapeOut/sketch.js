...
function setup() {
  ...
  describe("A centered white shape (circle, square, or triangle) on a dark gray canvas whose type and size are controlled by mouse clicks and movement and sent out over serial to a connected microcontroller.");
